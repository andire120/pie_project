<script>
    ...
    import pie from "/src/public/element/bread/tan-bread/herring-bread.png";
...
{#if count == 1}
    ...
    <div class="textbox" style="font-size: xx-large;">
        이봐, 대회 규정 좀 읽어봐. 파이라니까, 빵이 아니라.<br>게다가,너무 탔잖아? 넌 탈락이야.
    </div>
...
<div class="pies">
<img src={pie} alt="정어리빵" class="pie1">
<img src={pie} alt="정어리빵" class="pie2">
<img src={pie} alt="정어리빵" class="pie3">
</div>
