    ...
    const stories = [
        {
            ...
            simtext: "심사위원",
            pieimg:"/src/public/element/cookie/normal-cookie/pumpkin-cookie.png",
...
{:else if stories[pumpkinId - 1]}
    <button on:click|stopPropagation={() => refresh(`/cookie/strange/pumpkin-pie/${pumpkinId + 1}`)} class="button">
