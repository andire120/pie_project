    ...
    const stories = [
        {
            ...
            simtext: "심사위원",
            pieimg:"/src/public/element/bread/normal-cookie/apple-cookie.png",
...
{#if (appleId == 2)}
    ...
    <div class="textbox2">
        <div class="text2">
            {stories[appleId - 1].text}
        </div>  
    </div>
{:else if stories[appleId - 1]}
    <button on:click|stopPropagation={() => refresh(`/pie/tan/apple-pie/${appleId + 1}`)} class="button">
