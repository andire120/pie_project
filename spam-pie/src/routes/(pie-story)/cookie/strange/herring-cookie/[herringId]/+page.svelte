    ...
    const stories = [
        {
            ...
            simtext: "심사위원",
            pieimg:"/src/public/element/cookie/normal-cookie/herring-cookie.png",
...
{:else if stories[herringId - 1]}
    <button on:click|stopPropagation={() => refresh(`/cookie/strange/herring-pie/${herringId + 1}`)} class="button">
